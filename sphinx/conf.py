...
sys.path.insert(0, os.path.abspath(os.path.dirname(__file__) + '/primrose/conditionalpath'))
sys.path.insert(0, os.path.abspath(os.path.dirname(__file__) + '/primrose/configuration'))
